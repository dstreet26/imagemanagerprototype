defmodule ImagemanagerprototypeWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Imagemanagerprototype.MyChannel do
        use ImagemanagerprototypeWeb, :channel
        alias Imagemanagerprototype.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :imagemanagerprototype,
                        pubsub_server: Imagemanagerprototype.PubSub
end
